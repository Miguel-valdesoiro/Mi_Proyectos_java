 ...
 * @author pedro
 */
public class Combobox_Actualizar extends javax.swing.JFrame {

    // hacemos la llamada de conexion
    OperacionesCrud crud = new OperacionesCrud("Zoologico");

    public Combobox_Actualizar() {
        initComponents();
        llenarComboBox();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ACTUALIZAR Y ELIMINAR BASE DE DATOS");
    ...
    private void cmdActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdActualizarActionPerformed
        ...
        Zoologico zNuevo = new Zoologico(idZoo, descripcion, ciudad, superficie, precio, pais);
        System.out.println(zNuevo.getIdZoo());
        System.out.println(zNuevo.getDescripcion());
        System.out.println(zNuevo.getCiudad());
        System.out.println(zNuevo.getSuperficie());
        System.out.println(zNuevo.getPrecio());
        System.out.println(zNuevo.getPais());

        if (crud.actualizarZoologico(zNuevo)) {
            JOptionPane.showMessageDialog(this, "ELEMENTO ACTUALIZADO", "INFORMACION", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "ELEMENTO NO SE PUEDE ACTUALIZAR", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Combobox_Actualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Combobox_Actualizar().setVisible(true);
            }
        });
    }
